class Game {
  ...
  start() {
    ...
    //Agregando sprite de obstáculo al juego
    this.addSprites(
      obstacles,
  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      ...
      for (var plr in allPlayers) {
        ...
        //utiliza datos de la base de datos para mostarar autos en las direcciones x e y
  ...
  handleFuel(index) {
    ...
    // Reduciendo el combustible del jugador
